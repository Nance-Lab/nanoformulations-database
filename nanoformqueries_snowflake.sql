...
SELECT *
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS dls,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoformulations" AS n,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" AS r
WHERE n."formulation_id" = dls."formulation_id" AND
      dls."researcher_id" = r."researcher_id";
...
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS dls,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoformulations" as n,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" as r,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."single_emulsion" as s
WHERE dls."size" BETWEEN 50 AND 100 AND
      dls."zp" BETWEEN -10 AND 10 AND
      dls."pdi" BETWEEN 0 AND 0.2 AND
      n."formulation_id" = dls."formulation_id" AND
      dls."researcher_id" = r."researcher_id" AND
...
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS dls,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoformulations" as n,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" as r,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."double_emulsion" as d
WHERE dls."size" BETWEEN 50 AND 100 AND
      dls."zp" BETWEEN -10 AND 10 AND
      dls."pdi" BETWEEN 0 AND 0.2 AND
      n."formulation_id" = dls."formulation_id" AND
...
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS dls,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoformulations" as n,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" as r,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoprecipitation" as np
WHERE dls."size" BETWEEN 50 AND 100 AND
      dls."zp" BETWEEN -10 AND 10 AND
      dls."pdi" BETWEEN 0 AND 0.2 AND
      n."formulation_id" = dls."formulation_id" AND
...
SELECT *
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."experiment" AS ex,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."ldh_assay" AS ldh,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" AS r,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoformulations" AS n,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."pup_info" AS pup,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS np,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."nanoprecipitation" AS nano
...
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."experiment" AS ex,
      ...
      "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."pup_info" AS pup,
      "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS np,
      "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."double_emulsion" AS de
...
-- Query 11: To get all of Rick's double emulsion data with different sonication times
SELECT *
FROM "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."double_emulsion" AS de,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."np_charc" AS np,
     "NANCELAB_NANOFORMULATIONS_PUB"."PUBLIC"."researcher" AS r
WHERE de."time_1" IS NOT NULL AND
      np."np_activity" IS NOT NULL AND
      de."formulation_id" = np."formulation_id" AND
      de."researcher_id" = r."researcher_id";
